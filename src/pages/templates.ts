  ...
  return `
    <div class="page">
      ...
      <div class="disclaimer-banner">
        Generated documents are for guidance only &mdash; they do not constitute legal advice.
...
async function refreshPreviouslyGenerated(): Promise<void> {
  ...
  if (allDocs.length === 0) {
    listEl.innerHTML = '<div class="empty-state">No documents generated yet. Use the templates above to get started.</div>';
    return;
  }
